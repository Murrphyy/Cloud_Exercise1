...
app.get('/api/profile', (req, res) => {
  res.json({
    ...
    'email': 'melihkilic96@gmail.com',
    'deployedURLLink': '',//leave this blank for the first exercise
    'apiDocumentationURL': '', //leave this also blank for the first exercise
    'currentCity': 'Munich',
    'hobbies': ['boardgames','computergames','travel']
...
app.post('/api/books/', (req, res) => {
   ...
   */
  var newBook = new BooksModel({title:req.body.title,author:req.body.author,releaseDate:req.body.releaseDate,genre:req.body.genre,rating:req.body.rating,language:req.body.language});
  newBook.save().then(() => console.log("SAVED"));
  res.json(newBook);
});
...
app.put('/api/books/:id', (req, res) => {
   ...
   */
  db.books.findOneAndUpdate({_id : bookId},bookNewData,{new : true},function (err, books) {
    if (err) throw err;
    /*
     * return the object as array of json values
     */
